...
/**
 * source url: https://scrawkblog.com/2013/03/18/wireframe-shader-for-unity/
 * author: scrawk
 *
 * Adapated to represent vertex colors and transparency
 * Author: Lee Hailey
 * Date: 2016
 */
...
Shader "Unlit/Vertex Colors"
{
	...
	SubShader 
	{
		...
		// Perform individual pass for front back face to compensate for not sorting tris within an object
		// Pass to render back faces
		Pass 
		{
			Cull front
    	...
    	Pass 
    	{
			...
			half4 frag(g2f IN) : COLOR
			{
				...
				//fade based on dist from center
 				float I = exp2(-10.0*d*d);
				half4 surf = float4(0, 0.0, 0.0, 0.0);
				half4 wire = _WireColor;
						
				return lerp(surf, wire, I);		
			}
